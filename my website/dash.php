...
<div class="main">
  <div class="up">
    <button class="card1" onclick="window.open('https://instagram.com', '_blank')">
    ...
    <button class="card2" onclick="window.open('https://twitter.com', '_blank')">
  ...
  <div class="down">
    <button class="card3" onclick="window.open('https://github.com/osyaru9-art', '_blank')">
    ...
    <button class="card4" onclick="window.open('https://discord.com', '_blank')">
